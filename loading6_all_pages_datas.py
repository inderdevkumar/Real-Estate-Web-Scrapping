...
base = ("http://www.pyclass.com/real-estate/rock-springs-wy/LCWYROCKSPRINGS/t=0&s=")
#base = "http://www.pyclass.com/real-estate/rock-springs-wy/LCWYROCKSPRINGS/t=0&s="


for page in range(0, 30, 10):
    req= base+str(page)+".html"
    r = requests.get(req, headers={'User-agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:61.0) Gecko/20100101 Firefox/61.0'})
    c= r.content
    soup= BeautifulSoup(c, "html.parser")
    ...
    for item in alll:
        ...
        for column_group in item.find_all("div", {"class": "columnGroup"}):
            #for extra featues which are hidden once go in details
